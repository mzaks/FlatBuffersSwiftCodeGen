...
if CommandLine.arguments.count > 3
    ...
    let builderData = try Data(contentsOf: URL(string: "https://raw.githubusercontent.com/mzaks/FlatBuffersSwift/1.0.1/FlatBuffersSwift/FlatBuffersBuilder.swift")!)
    ...
    let readerData = try Data(contentsOf: URL(string: "https://raw.githubusercontent.com/mzaks/FlatBuffersSwift/1.0.1/FlatBuffersSwift/FlatBuffersReader.swift")!)
