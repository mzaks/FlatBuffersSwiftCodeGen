...
if CommandLine.arguments.count > 3
    ...
    let builderData = try Data(contentsOf: URL(string: "https://raw.githubusercontent.com/mzaks/FlatBuffersSwift/2.0.0/FlatBuffersSwift/FlatBuffersBuilder.swift")!)
    ...
    let readerData = try Data(contentsOf: URL(string: "https://raw.githubusercontent.com/mzaks/FlatBuffersSwift/2.0.0/FlatBuffersSwift/FlatBuffersReader.swift")!)
